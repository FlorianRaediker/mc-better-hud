...
execute unless score $custom_hud/timer.last bingo.tmp = $custom_hud/timer.cur bingo.tmp if data storage bingo:custom_hud currentPlayer.components[{id: "bingo:timer"}] run scoreboard players set $custom_hud/timer.update_timer bingo.tmp 1
